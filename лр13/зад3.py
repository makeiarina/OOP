...
window.configure(background="lightblue") # Задаем цвет фона окна
# Создаем Label с текстом "Брось кубик" и устанавливаем шрифт Arial размером 14.
label = Label(window, text="Брось кубик", font=("Arial", 14),fg="indigo")
label.pack(pady=20)
...
button = Button(window, text="Бросить кубик", font=("Arial", 14), command=roll_dice,bg="lightgreen")
button.pack(pady=10)
